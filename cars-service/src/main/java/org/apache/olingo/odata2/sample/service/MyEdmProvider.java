...
public class MyEdmProvider extends EdmProvider {
  ...
  static final String ENTITY_SET_NAME_COUNTRIES = ENTITY_SET_NAME_MANUFACTURERS;
  static final String ENTITY_SET_NAME_STATES = ENTITY_SET_NAME_CARS;
...
*/
  ...
  //          .setNavigationProperties(navigationProperties);
        ...
        // Properties
        List<Property> properties = new ArrayList<Property>();
        properties.add(new SimpleProperty().setName("Id").setType(EdmSimpleTypeKind.String).setFacets(
            new Facets().setNullable(false)));
...
public class MyEdmProvider extends EdmProvider {
  ...
  static final String ENTITY_SET_NAME_COUNTRIES = "Countries";
  static final String ENTITY_SET_NAME_STATES = "States";
  static final String ENTITY_NAME_COUNTRY = "Country";
  static final String ENTITY_NAME_STATE = "State";

  private static final String NAMESPACE = "org.apache.olingo.odata2.OData" + ENTITY_SET_NAME_STATES;

  private static final FullQualifiedName ENTITY_TYPE_1_1 = new FullQualifiedName(NAMESPACE, ENTITY_NAME_STATE);
  private static final FullQualifiedName ENTITY_TYPE_1_2 = new FullQualifiedName(NAMESPACE, ENTITY_NAME_COUNTRY);

  private static final FullQualifiedName COMPLEX_TYPE = 
		  new FullQualifiedName(NAMESPACE, "Address");

  private static final FullQualifiedName ASSOCIATION_PARENT_CHILD = 
		  new FullQualifiedName(NAMESPACE, 
				  ENTITY_NAME_STATE + "_" + 
				  ENTITY_NAME_COUNTRY + "_" + 
				  ENTITY_NAME_COUNTRY + "_" + 
				  ENTITY_SET_NAME_STATES);

  private static final String ROLE_1_1 = 
		  ENTITY_NAME_STATE + "_" + ENTITY_NAME_COUNTRY;
  private static final String ROLE_1_2 = 
		  ENTITY_NAME_COUNTRY + "_" + ENTITY_SET_NAME_STATES;

  private static final String ENTITY_CONTAINER = 
		  "OData" + ENTITY_SET_NAME_STATES + "EntityContainer";

  private static final String ASSOCIATION_SET = 
		  ENTITY_SET_NAME_STATES + "_" + ENTITY_SET_NAME_COUNTRIES;

  private static final String FUNCTION_IMPORT = 
		  "NumberOf" + ENTITY_SET_NAME_STATES;
  ...
  public List<Schema> getSchemas() throws ODataException {
    ...
    List<Association> associations = new ArrayList<Association>();
    associations.add(getAssociation(ASSOCIATION_PARENT_CHILD));
    schema.setAssociations(associations);
    ...
    List<EntitySet> entitySets = new ArrayList<EntitySet>();
    entitySets.add(getEntitySet(ENTITY_CONTAINER, ENTITY_SET_NAME_STATES));
    entitySets.add(getEntitySet(ENTITY_CONTAINER, ENTITY_SET_NAME_COUNTRIES));
    entityContainer.setEntitySets(entitySets);

    List<AssociationSet> associationSets = new ArrayList<AssociationSet>();
    associationSets.add(getAssociationSet(ENTITY_CONTAINER, ASSOCIATION_PARENT_CHILD, ENTITY_SET_NAME_COUNTRIES, ROLE_1_2));
    entityContainer.setAssociationSets(associationSets);
  ...
  public EntityType getEntityType(FullQualifiedName edmFQName) throws ODataException {
    if (NAMESPACE.equals(edmFQName.getNamespace())) {
      ...
      if (ENTITY_TYPE_1_1.getName().equals(edmFQName.getName())) {
        ...
        List<NavigationProperty> navigationProperties = new ArrayList<NavigationProperty>();
        navigationProperties.add(new NavigationProperty().setName("Manufacturer")
            .setRelationship(ASSOCIATION_PARENT_CHILD).setFromRole(ROLE_1_1).setToRole(ROLE_1_2));
        ...
        //Navigation Properties
        List<NavigationProperty> navigationProperties = new ArrayList<NavigationProperty>();
        navigationProperties.add(new NavigationProperty().setName(ENTITY_SET_NAME_STATES)
            .setRelationship(ASSOCIATION_PARENT_CHILD).setFromRole(ROLE_1_2).setToRole(ROLE_1_1));
  ...
  public Association getAssociation(FullQualifiedName edmFQName) throws ODataException {
    if (NAMESPACE.equals(edmFQName.getNamespace())) {
      if (ASSOCIATION_PARENT_CHILD.getName().equals(edmFQName.getName())) {
        return new Association().setName(ASSOCIATION_PARENT_CHILD.getName())
  ...
  public EntitySet getEntitySet(String entityContainer, String name) throws ODataException {
    if (ENTITY_CONTAINER.equals(entityContainer)) {
      if (ENTITY_SET_NAME_STATES.equals(name)) {
        return new EntitySet().setName(name).setEntityType(ENTITY_TYPE_1_1);
      } else if (ENTITY_SET_NAME_COUNTRIES.equals(name)) {
        return new EntitySet().setName(name).setEntityType(ENTITY_TYPE_1_2);
      }
    }
    return null;
  ...
  public AssociationSet getAssociationSet(String entityContainer, FullQualifiedName association, String sourceEntitySetName, String sourceEntitySetRole) throws ODataException {
    if (ENTITY_CONTAINER.equals(entityContainer)) {
      if (ASSOCIATION_PARENT_CHILD.equals(association)) {
        return new AssociationSet().setName(ASSOCIATION_SET)
            .setAssociation(ASSOCIATION_PARENT_CHILD)
            .setEnd1(new AssociationSetEnd().setRole(ROLE_1_2).setEntitySet(ENTITY_SET_NAME_COUNTRIES))
            .setEnd2(new AssociationSetEnd().setRole(ROLE_1_1).setEntitySet(ENTITY_SET_NAME_STATES));
      }
    }
    return null;
  }
  ...
  public EntityContainerInfo getEntityContainerInfo(String name) throws ODataException {
    if (name == null || ("OData" + ENTITY_SET_NAME_COUNTRIES + "EntityContainer").equals(name)) {
      return new EntityContainerInfo().setName("OData" + ENTITY_SET_NAME_COUNTRIES + "EntityContainer").setDefaultEntityContainer(true);
    }
